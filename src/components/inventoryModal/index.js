  ...
  return (
    <Form>
      <div style={{ padding: "16px", paddingBottom: 0 }}>
        <h1 className={style.commTitle}>Add a new resource to the inventory</h1>
            ...
            <Field
              ...
              render={({ field /* _form */ }) => (
                <Select
                  ...
                  onChange={value => setFieldValue("unit", value.value)}
                />
              )}
            />
        ...
        <div
          ...
          style={{ height: "100px", marginTop: "0px", marginBottom: "0px" }}
        >
          <Field
            name="note"
            render={({ field /* _form */ }) => (
